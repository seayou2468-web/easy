...
#if defined(DISABLE_NON_IOS_PLATFORM_CODE)
// iOS-only build profile: force-touch input-only behavior and avoid
// enabling desktop/non-iOS input feature surfaces.
#  define USE_TOUCH
#elif defined(__APPLE__) && TARGET_OS_IOS
// iOS: keep input feature surface minimal/stable for touch-first runtime.
#  define USE_TOUCH
#else
#  define USE_KEYBOARD
#  define USE_MOUSE
