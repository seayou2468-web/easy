...
extern "C" int main(int argc, char* argv[]) {
	...
	SDL_Log("EasyRPG iOS startup: entered main()");
	SDL_Log("EasyRPG iOS startup: argc=%d", argc);
#endif
...
#if defined(__APPLE__) && TARGET_OS_IOS
	SDL_Log("EasyRPG iOS startup: Player::Init() completed");
#endif
	Player::Run();
#if defined(__APPLE__) && TARGET_OS_IOS
	SDL_Log("EasyRPG iOS startup: Player::Run() returned");
#endif
